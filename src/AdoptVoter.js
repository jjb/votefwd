        ...
        <div className="row no-gutters position-relative">
          ...
          <div className="col-lg-6 order-lg-1 showcase-text bg-light p-5">
            <div className="p-2 p-5-m">
              <h3>You’re helping flip <a href={'/district/' + this.state.district.district_id}>{this.state.district.district_id}</a> blue <button className="btn btn-link" onClick={this.props.toggleDistrictPicker}>Switch District</button></h3>
