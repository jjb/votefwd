  ...
  render() {
    ...
    return (
      <div className="jumbotron">
        ...
        <button disabled={this.state.adopting ? true : false} onClick={() => this.adoptVoter(1)} className="btn btn-primary btn-lg mr-2">1</button>
        <button disabled={this.state.adopting ? true : false} onClick={() => this.adoptVoter(5)} className="btn btn-primary btn-lg mr-2">5</button>
        <button disabled={this.state.adopting ? true : false} onClick={() => this.adoptVoter(15)} className="btn btn-primary btn-lg mr-2">15</button>
        {content}
      </div>
    )
  }
