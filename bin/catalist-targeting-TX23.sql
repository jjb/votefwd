...
BEGIN
  ...
  INSERT INTO experiment VALUES
    (DEFAULT, 'TX23', 'Propensity 5-45, Dem partisanship > 70, Spanish score unknown or <60.')
  ...
  AND state='TX'
  AND congressional_district='23'
  AND catalist_spanish_speaker!='60-80'
  AND catalist_spanish_speaker!='80-100';
